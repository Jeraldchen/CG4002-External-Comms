...
if __name__ == '__main__':
    try:
        ...
        # Create processes
        relay_node_server_player1 = Process(target=relay_node_server_process, args=(to_ai_queue, from_ai_queue, shoot_action_queue, got_shot_queue, 8800, from_ai_queue)) # send IMU to AI and send true game state to internal comms
        relay_node_server_player2 = Process(target=relay_node_server_process, args=(to_ai_queue, from_ai_queue, shoot_action_queue, got_shot_queue, 8801, from_ai_queue)) # send IMU to AI and send true game state to internal comms
        ...
        # game_engine = Process(target=game_engine_process, args=(mqtt_publish_queue, mqtt_subscribe_queue, from_ai_queue, ai_game_state_send_to_eval_server_queue, 
        ...
        #                                                         true_game_state_from_eval_server_queue, shoot_action_queue, got_shot_queue)) 
